...
# Default for ORACLE_PDB_COUNT
export ORACLE_PDB_COUNT=${ORACLE_PDB_COUNT:-1}

# Default for ORACLE_EM_CONFIG
export ORACLE_EM_CONFIG=${ORACLE_EM_CONFIG:-NONE}

# Default for ORACLE CHARACTERSET
export ORACLE_CHARACTERSET=${ORACLE_CHARACTERSET:-AL32UTF8}

# Default for ORACLE_NLS_CHARACTERSET
...
if [ -d $ORACLE_BASE/oradata/$ORACLE_SID ]; then
  ...
  # Create database
  $ORACLE_BASE/$CREATE_DB_FILE $ORACLE_SID $ORACLE_PDB_COUNT $ORACLE_PDB $ORACLE_PWD;
