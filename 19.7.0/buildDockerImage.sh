...
# Description: Build script for building Oracle Docker images.
# 
...
docker build --force-rm=true --no-cache=true \
  ...
  echo ""
  echo "ERROR: Oracle Docker Image was NOT successfully created."
...
cat << EOF
  Oracle Docker Image for version $VERSION is ready to be extended: 
